 ...
 */
template <typename Dtype>
class LSTMLinearLayer : public RecurrentLayer<Dtype> {
 public:
  explicit LSTMLinearLayer(const LayerParameter& param)
      : RecurrentLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "LSTMLinear"; }
 ...
 */
template <typename Dtype>
class LSTMLinearUnitLayer : public Layer<Dtype> {
 public:
  explicit LSTMLinearUnitLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "LSTMLinearUnit"; }
